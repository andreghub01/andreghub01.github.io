  ...
  (d.prototype = {
    show: function () {
      ...
      if (c && this.enabled) {
        var d = this.tip(),
          e = ".tipsy-inner";
        this.options.kepsy && (e = ".kepsy-inner"),
          d.find(e)[this.options.html ? "html" : "text"](c),
          (d[0].className = "tipsy"),
          d
            .remove()
        ...
        var j,
          f = a.extend({}, this.$element.offset(), {
        ...
        2 == i.length &&
          ...
          d.css(j).addClass("tipsy-" + i),
          (d.find(".tipsy-arrow")[0].className =
            "tipsy-arrow tipsy-arrow-" + i.charAt(0)),
    ...
    tip: function () {
      var b = '<div class="tipsy-arrow"></div><div class="tipsy-inner"></div>';
      return (
        this.options.kepsy &&
          (b =
            '<div class="tipsy-arrow"></div><div class="kepsy-inner"></div>'),
        this.$tip ||
          ((this.$tip = a('<div class="tipsy"></div>').html(b)),
